<?php
    ...
    if(empty($reportType) || empty($grahtype) || empty($yeMonth)){
        ...
        // genarate table
        //header("Location:../reportTables/priChatMsgRecTableWeek.php?reporttime=".$yeMonth."");
        echo "<script>window.close();</script>"; // if empty inputs close tab
        exit();
    }
        ...
        exec('C:\\"Program Files"\\R\\R-4.0.3\\bin\\Rscript.exe C:\\xampp\\htdocs\\chatchops\\R_privatGroupChat\\R_WeekPriGrpChat.R ' . $sd . ' ' . $ed);
