        ...
        <div class="container">
            <nav class = "header-bar">
                <h1>
                    ...
                    Report for number of Private Chat Messages In given Day
                </h1>
            </nav>
            <main class="report-main">
                ...
                <?php
                    if(isset($_GET['reporttime']) && !empty($_GET['reporttime'])){
                        ...
                        $datas = $priobj->getDayPriChatMsg($_GET['reporttime']);
                        unset($priobj);
                    }
                ?>
                <table class="d-table">
                    <thead>
                        <tr>
                            <th>Time</th>
                            <th>Number of Private chat Messages</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
            ...
            <div id="sidebar">
                <div class="form-div">
                    <form action="priChatMsgRecTableDay.php" method="get">
                ...
                <div class="chart-dis">
                    ...
                    <?php
                        if(isset($_GET['reporttime']) && !empty($_GET['reporttime'])){
                           echo '<p class="t-head">Number of private chat messages in </p>';
