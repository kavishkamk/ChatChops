        ...
        <div class="container">
            <nav class = "header-bar">
                <h1>
                    ...
                    Report for number of private Chat Messages In given Month
                </h1>
            </nav>
            <main class="report-main">
                ...
                <?php
                    if(isset($_GET['reporttime']) && !empty($_GET['reporttime'])){
                        ...
                        $datas = $priobj->getMonthPriChatMsg($arr[1], $arr[0]);
                        unset($priobj);
            ...
            <div id="sidebar">
                <div class="form-div">
                    <form action="priChatMsgRecTableMonth.php" method="get">
