        ...
        <div class="container">
            <nav class = "header-bar">
                <h1>
                    ...
                    Report for number of private chat messages In given Week
                </h1>
            </nav>
            <main class="report-main">
                ...
                <?php
                    if(isset($_GET['reporttime']) && !empty($_GET['reporttime'])){
                        ...
                        $datas = $priobj->getWeekPriChatMsg($arr[0], $arr[1], $arr[2]);
                        unset($priobj);
                    }
                ?>
                <table class="d-table">
            ...
            <div id="sidebar">
                <div class="form-div">
                    <form action="priChatMsgRecTableWeek.php" method="get">
